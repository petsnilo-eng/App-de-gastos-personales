...
const marco = { position: 'relative', background: C.bg, color: C.text, fontFamily: 'Inter, ui-sans-serif, system-ui, sans-serif', height: 720, maxWidth: 390, margin: '0 auto', borderRadius: 28, overflow: 'hidden', border: `1px solid ${C.border}`, display: 'flex', flexDirection: 'column' };
...
function FaltanClaves() {
  return (
    <div style={{ ...marco, justifyContent: 'center', padding: 28, boxSizing: 'border-box', textAlign: 'center' }}>
...
function Finanzas() {
  ...
  return (
    <div style={marco}>
      ...
      <div style={{ flex: 1, padding: '16px 18px 90px', overflowY: 'auto' }}>
        {fin.cargando ? (
...
function Header({ tab, mes, anio, shiftMonth }) {
  ...
  return (
    <div style={{ padding: '16px 18px 12px', borderBottom: `1px solid ${C.border}`, background: 'rgba(11,15,20,0.9)' }}>
...
function BottomNav({ tab, setTab }) {
  ...
  return (
    <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, background: 'rgba(16,21,28,0.97)', borderTop: `1px solid ${C.border}`, display: 'flex', justifyContent: 'space-around', padding: '10px 4px' }}>
